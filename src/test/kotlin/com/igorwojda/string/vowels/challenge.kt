...
private fun vowels(str: String): Int {
    ...
    val existingVowels = mutableListOf<String>()

    str.forEach { if (vowelsList.contains(it.toString().toLowerCase())) existingVowels.add(it.toString()) }

    return existingVowels.size
}
